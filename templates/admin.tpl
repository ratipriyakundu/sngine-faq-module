        ...
        <div class="card mb15">
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <!-- FAQ Pages -->
              <li {if $view == "faq"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/faq">
                  <i class="fa fa-question-circle fa-lg fa-fw mr10" style="color: #FF5722"></i>{__("FAQ Pages")}
                </a>
              </li>
              <!-- FAQ Pages -->
